export default function SuccessMessage({ setIsFormSuccess }) {
  ...
  return (
    <>
      <div
        id="successModal"
        className="bg-opacity-50 bg-black overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full flex"
      >
